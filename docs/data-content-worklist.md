...
- ⬜ [dh:structure-pseudo] 1 known structurally-wrong style rows (stable backlog, cleanup staged). They render as junk tiles in search and break the bag-page hierarchy until merged. Action: Owner: npx tsx scripts/ux-restructure/merge-pseudo-styles.ts --apply (dry-run first; docs/ux-review-0714-merge-report.md). (first seen 2026-07-19, last seen 2026-09-26, yellow)
- ✅ [dh:contamination-dupes] resolved 2026-09-26 (Same-day duplicate listing rows (last ~24h) is back to normal)
<!-- data-health:end -->
