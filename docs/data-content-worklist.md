...
- ✅ Templated Lou Camera, Le 5 à 7 (SL, DB attribution correct), Pochette Accessoires, Hourglass, Niki, Multi Pochette, 30 Montaigne. **48 styles faceted total** (through main df0de3b). Selector dims verified end-to-end via visibleDims (Size/Colour/Material/Construction render correctly).
