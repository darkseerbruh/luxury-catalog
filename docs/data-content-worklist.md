...
- ⬜ [dh:ranking-snapshot] No LC Index snapshot exists yet, so the ranking movement pills have nothing to compare against. Action: The monthly cron fires on the 1st (CRON_SECRET verified set in Vercel prod, 2026-07-10); to backfill now, curl /api/cron/lc-index-snapshot with the Bearer secret. (first seen 2026-07-10, last seen 2026-07-19, yellow)
- ⬜ [dh:coverage-condition] Condition coverage (listed rows) fell from 29.4% to 17.5% since the last run. Action: Run the condition backfill lane (condition-backfill.yml). (first seen 2026-07-19, last seen 2026-07-19, red)
- ⬜ [dh:coverage-region] Region coverage (all rows) fell from 42.5% to 39.8% since the last run. Action: Check the feed country-tag mapping in the Fashionphile backfill. (first seen 2026-07-19, last seen 2026-07-19, yellow)
- ⬜ [dh:coverage-hardware] Hardware-color coverage (all rows) fell from 33.7% to 28.1% since the last run. Action: Check the spec-extract vocab (src/lib/ingest/spec-extract.ts) against recent titles. (first seen 2026-07-11, last seen 2026-07-19, red)
- ⬜ [dh:coverage-style-description] Style descriptions fell from 43.3% to 39.8% since the last run. Action: Queue a page-depth batch (docs/data-content-worklist.md PAGE-DEPTH lane). (first seen 2026-07-19, last seen 2026-07-19, yellow)
- ⬜ [dh:backlog-total] The unpromoted backlog grew from 77212 to 176170 rows since the last run; capture is outpacing promotion. Action: Schedule a promotion session (promote-safe --create-new) or grow the dictionary coverage. (first seen 2026-07-12, last seen 2026-07-19, red)
- ⬜ [dh:contamination-trr] 127 TRR rows captured in the last week would fail today's non-bag filter, so non-bag items are leaking back in. Action: Run the TRR non-bag cleanup scripts (cleanup-trr-nonbag.ts) and check the ingest gate. (first seen 2026-07-10, last seen 2026-07-19, red)
- ⬜ [dh:contamination-dupes] 293 listings were written more than once for the same observation day, which contaminates medians until deduped. Action: Inspect the newest loads; the loader should upsert on platform|listing_ref|price_type|observed_on. (first seen 2026-07-10, last seen 2026-07-19, red)
- ⬜ [dh:structure-pseudo] 1 known structurally-wrong style rows (stable backlog, cleanup staged). They render as junk tiles in search and break the bag-page hierarchy until merged. Action: Owner: npx tsx scripts/ux-restructure/merge-pseudo-styles.ts --apply (dry-run first; docs/ux-review-0714-merge-report.md). (first seen 2026-07-19, last seen 2026-07-19, yellow)
- ✅ [dh:freshness-fashionphile] resolved 2026-07-19 (Fashionphile freshness is back to normal)
- ✅ [dh:coverage-listing-images] resolved 2026-07-19 (Listing photos (myGemma) is back to normal)
- ✅ [dh:contamination-misattach] resolved 2026-07-19 (Foreign items on bag variants (last 7 days) is back to normal)
- ✅ [dh:contamination-size] resolved 2026-07-19 (Size-mismatched rows on a variant (last 7 days) is back to normal)
<!-- data-health:end -->
