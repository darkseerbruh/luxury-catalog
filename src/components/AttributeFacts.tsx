    ...
    <>
      {hardware.total > 0 && (
        <section className="rounded-2xl border border-gold/30 bg-gold/5 p-6">
          <p className="text-sm uppercase tracking-widest text-gold">How the hardware splits</p>
      ...
      {colors.length > 0 && (
        <section className="rounded-2xl border border-gold/30 bg-gold/5 p-6">
          <p className="text-sm uppercase tracking-widest text-gold">What color is luxury</p>
