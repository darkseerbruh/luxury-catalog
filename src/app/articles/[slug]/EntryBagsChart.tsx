 ...
 * Current asking medians, date-clean, re-confirmed against prod 2026-07-10 (deduped by
 * listing_ref), stated with n per docs/data-analysis-standard.md. Asking ("listing for"),
 * not sold. Original SVG/CSS.
 *  Gucci Marmont small $1,095 (n=183) · LV Neverfull MM $1,515 (n=345) · LV Speedy 30 $1,375 (n=148)
 */
const FG = "#f3ede0";
const MUTED = "#a89c87";
const GOLD = "#c9a24c";
...
const ROWS = [
  { label: "Gucci GG Marmont", sub: "small shoulder", v: 1095, n: 183 },
  { label: "LV Neverfull", sub: "MM tote", v: 1515, n: 345 },
  { label: "LV Speedy", sub: "30 handheld", v: 1375, n: 148 },
];
    ...
    <figure style={{ margin: "0.5rem 0 1rem" }}>
      <div style={{ border: `1px solid ${BORDER}`, borderRadius: 14, padding: 18, background: "#14120c", color: FG, maxWidth: 560 }}>
        ...
        <div style={{ fontSize: 10.5, color: MUTED, marginTop: 14, lineHeight: 1.5 }}>
          Asking medians from our tracking of current listings, July 2026. All three sit in the same entry band, so the choice is about fit and use, not price. Estimate from current listings, not an appraisal.
        </div>
      </div>
      <figcaption className="sr-only">
        Three entry-level icons at similar asking prices: Gucci GG Marmont small around $1,095, Louis Vuitton Neverfull MM around $1,515, and Louis Vuitton Speedy 30 around $1,375.
      </figcaption>
    </figure>
  );
}
